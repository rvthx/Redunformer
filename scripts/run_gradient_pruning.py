...
from redundancy.measurement import load_gradient_importance
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run gradient-importance attention-head pruning")
...
def main():
    ...
    cached = load_gradient_importance(args.measurement_file) if args.measurement_file else None
    ...
    payload = {
        ...
        "measurement_batches": args.importance_batches,
    ...
    print(f"Gradient pruning completed: {output}")
